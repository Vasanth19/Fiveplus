...
.directive('field', function ($compile, $http, $templateCache, $interpolate) {
    ...
    return {
        ...
        compile: function compile(element, attrs) {
            ...
            var attrOptional = false; // default
            if (element.attr('optional')) {
                attrOptional = element.attr('optional');
                element[0].removeAttribute('optional');
            }
            ...
            return function (scope, element, attrs, formController) {
                ...
                getFieldElement.then(function (newElement) {
                    ...
                    childScope.optional = attrOptional;
