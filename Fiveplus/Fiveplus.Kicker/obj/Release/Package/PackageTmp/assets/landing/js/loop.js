jQuery( function($){
	...
	function setNavbarLight() {
		...
		$('.navbar-brand img').attr('src', '../assets/landing/img/Hifive-logo.png');
	}

	function setNavbarTransparent() {
		$('.navbar').removeClass('navbar-light');
		$('.navbar-brand img').attr('src', '../assets/landing/img/Hifive-logo-white.png');
	}
	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{ image: '/assets/landing/img/sliders/slider1.jpg', title: '<div class="hero-text"><h2 class="hero-heading">START SMALL, REACH YOUR GOAL</h2><p>Built to provide great Seller and Buyer experience</p></div>', thumb: '', url: '' },
							{ image: '/assets/landing/img/sliders/slider2.jpg', title: '<div class="hero-text"><h2 class="hero-heading">PARALLAX</h2><p>Scrolling the page is fun with parallax background</p></div>', thumb: '', url: '' },
							{ image: '/assets/landing/img/sliders/slider3.jpg', title: '<div class="hero-text"><h2 class="hero-heading">BUY ONE FOR TWO</h2><p>Buy one to get both of the agency and personal theme</p></div>', thumb: '', url: '' }
						],
		});
